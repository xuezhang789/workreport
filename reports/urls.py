...
urlpatterns = [
    ...
    path('workbench/stats/', statistics_views.workbench_stats, name='workbench_stats'),
    path('workbench/projects/', statistics_views.workbench_projects, name='workbench_projects'),
    path('workbench/reports/', statistics_views.workbench_reports, name='workbench_reports'),
    path('workbench/tasks/', statistics_views.workbench_tasks, name='workbench_tasks'),
    path('stats/', statistics_views.stats, name='stats'),
    path('performance_board/', statistics_views.performance_board, name='performance_board'), # Changed from 'performance/' to 'performance_board/'
    ...
    path('teams/<int:user_id>/projects/', views_teams.team_member_projects, name='team_member_projects'),
